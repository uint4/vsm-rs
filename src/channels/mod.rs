...
//! explicitly. System 5 currently records channel events in service history,
//! while System 1 handles selected command, coordination, and audit messages.
//! Typed System 2 coordination, System 3 control/audit, and System 4
//! intelligence run through `VsmRuntime` subsystem handles.
